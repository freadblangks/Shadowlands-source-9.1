...
REPLACE INTO `areatrigger_template` (`Id`, `Data1`, `Data2`, `IsServerSide`, `ScriptName`) VALUES ('327125', '2.5', '2.5', '0',  'at_fragments_of_shadow');
...
UPDATE `areatrigger_template` SET `IsServerSide`='0' WHERE (`Id`='24030');

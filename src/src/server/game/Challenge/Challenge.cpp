...
//    else
//    {
//        ChatHandler(player).PSendSysMessage("Error: Need group.");
//        _canRun = false;
//        return;
//    }
//
...
//
//    if (HasAffix(Affixes::Teeming) && !creature->isSummon() && !creature->IsAffixDisabled() && roll_chance_f(30.0f) && creature->GetDBTableGUIDLow()) // Only for real creature summon copy
//    {
//        Position pos;
//        creature->GetNearPosition(pos, 6.0f, creature->GetOrientation());
...
//    creature->AddAura(ChallengersMight, creature);
//
//    /* if (HasAffix(Affixes::Teeming) && creature->IsHostileToPlayers() && !creature->isSummon() && !creature->IsAffixDisabled() && roll_chance_f(30.0f) && creature->GetDBTableGUIDLow()) // Only for real creature summon copy
//    {
//        Position pos;
//        creature->GetRandomPoint(*creature, 5.0f, pos);
//        creature->SummonCreature(creature->GetEntry(), pos, TEMPSUMMON_DEAD_DESPAWN, 60000);
//    } */
//}
//

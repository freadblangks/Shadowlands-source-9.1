...
enum SMART_EVENT
{
    ...
    SMART_EVENT_PLAYER_CHOICE_RESPONSE = 82,      // playerChoiceResponseId
    SMART_EVENT_END = 83
};
...
enum SMART_ACTION
{
    ...
    SMART_ACTION_MOD_CURRENCY = 216,     // Modify currency to player by ID and count
...
enum SmartScriptType
{
    ...
    SMART_SCRIPT_TYPE_PLAYER_CHOICE = 11, // done
...
enum SmartAITypeMaskId
{
    ...
    SMART_SCRIPT_TYPE_MASK_PLAYER_CHOICE = 2048
};
...
const uint32 SmartAITypeMask[SMART_SCRIPT_TYPE_MAX][2] =
{
    ...
    {SMART_SCRIPT_TYPE_PLAYER_CHOICE,       SMART_SCRIPT_TYPE_MASK_PLAYER_CHOICE },
};
...
const uint32 SmartAIEventMask[SMART_EVENT_END][2] =
{
    ...
    {SMART_EVENT_PLAYER_CHOICE_RESPONSE,    SMART_SCRIPT_TYPE_MASK_PLAYER_CHOICE },
};

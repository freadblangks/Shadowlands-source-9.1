                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SEND_SWARMERS:
                            Talk(SAY_SWARMERS);
                            me->MonsterTextEmote(ANN_SWARMERS, NULL, true);
                            if (Creature* Yang = me->FindNearestCreature(NPC_YANG_IRONCLAW, 500.0f, true))
                        ...
                        case EVENT_SEND_DEMOLISHERS:
                            ...
                            me->MonsterTextEmote(ANN_DEMOLISHERS, NULL, true);
                            if (Creature* Yang = me->FindNearestCreature(NPC_YANG_IRONCLAW, 500.0f, true))
                        ...
                        case EVENT_SEND_SWARMERS_WARRIOR:
                            Talk(SAY_WARRIORS);
                            me->MonsterTextEmote(ANN_SWARMERS_WARRIOR, NULL, true);
                            if (Creature* Yang = me->FindNearestCreature(NPC_YANG_IRONCLAW, 500.0f, true))
                        ...
                        case EVENT_SEND_DEMOLISHERS_WARRIOR:
                            ...
                            me->MonsterTextEmote(ANN_DEMOLISHERS_WARRIOR, NULL, true);
                            if (!wave4Adds.empty())
                        ...
                        case EVENT_THOUSAND_BLADES:
                            ...
                            if (me->HasAura(SPELL_CAUSTIC_TAR))
                                me->MonsterTextEmote(ANN_CAUSTIC_SHAKE, NULL, true);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_MOVE_BOMBARD_POSITION:
                            if (flyPointReached == 0)
                            {
                                if (Creature* Vojak = me->FindNearestCreature(BOSS_COMMANDER_VOJAK, 500.0f, true))
                                {
                                    ...
                                    Vojak->MonsterTextEmote(ANN_AMBERWING, NULL, true);
                                }
                        ...
                        case EVENT_BOMBARDING_DONE:
                            me->MonsterTextEmote(ANN_AMBERWING_AMMUNITION, NULL, true);
                            ammoFinished = true;
                            me->GetMotionMaster()->MoveTargetedHome();
                            break;

...
private:
    ...
    void Reset() override
    {
        ...
        //me->AddAura(AURA_OVERRIDE_POWER_COLOR_RAGE, me); Need ID
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        {
            players->AddAura(SPELL_BURDEN_OF_SIN_PERIODIC_DUMMY, players);
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case SPELL_CLEANSING_PAIN:
            me->AddAura(SPELL_CLEANSING_PAIN_ALLLOW_CAST, me);
        ...
        case SPELL_SHATTERING_PAIN_TRIGGER:
            ...
            if (Unit* target = SelectTarget(SELECT_TARGET_MAXTHREAT, 0, 25.0f, true))
            {
...
struct npc_remornia : public ScriptedAI
{
    ...
    void DoAction(int32 action)
    {
        ...
        case ACTION_REMORNIA_EVENTS:
            ...
            //m_Events.ScheduleEvent(SPELL_IMPALE_MARK, 10s);
            break;
        }
    }
};
